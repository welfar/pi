...
import { dataRegTableState } from "../../../recoil/atoms";
import { FaEdit, FaTrashAlt } from "react-icons/fa";

const RegTable = ({ setItem, setEditItem, setId }) => {
  const [data, setData] = useRecoilState(dataRegTableState);
              ...
              return (
                <>
                  <div key={index} style={{ display: "flex", width: "100%" }}>
                    <div className="row__content" style={{ width: "25%" }}>
                      {item.subdomain}
                    </div>
                    <div className="row__content" style={{ width: "25%" }}>
                      {item.domain}
